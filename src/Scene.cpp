...
void main()
{
    out_color = vec4(texture(light_render_map, texcoord).rg, 0.0, 1.0);
}
)";
...
//        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    ...
    void Scene::create_scene() {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RG32F, light_map_resolution, light_map_resolution, 0, GL_RGBA, GL_FLOAT, nullptr);
